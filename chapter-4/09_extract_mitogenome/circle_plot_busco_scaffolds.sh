...
ASSEMBLY_FILE=/nesi/nobackup/vuw03922/projects/$PROJECT/data/Chapter3/assemblies/flye/4_nuclear_only/$SAMPLE'_'$FILTER'_nuclear'/$SAMPLE'_busco_scaffolds.fasta'

out=/nesi/nobackup/vuw03922/projects/$PROJECT/output/Chapter3/flye_assembly/4_nuclear_only/$SAMPLE'_'$FILTER'_nuclear'/$SAMPLE'_'$FILTER'_busco_scaffolds.circle_plot'
mkdir -p $out
