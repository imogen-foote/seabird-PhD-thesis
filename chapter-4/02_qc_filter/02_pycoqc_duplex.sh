...
#SBATCH --job-name=pycoqc_duplex
#SBATCH -o /nesi/nobackup/vuw03922/stdout/pycoqc_duplex.%j.out
#SBATCH -e /nesi/nobackup/vuw03922/stdout/pycoqc_duplex.%j.err
...
#run program
pycoQC -f $read_dir/sequencing_summary*.txt --min_pass_qual 10 --min_pass_len 200 -o $output_dir/$LIB.DUPLEX_pycoqc_qual10_len200.html
pycoQC -f $read_dir/sequencing_summary*.txt --min_pass_qual 15 --min_pass_len 200 -o $output_dir/$LIB.DUPLEX.pycoqc_qual15_len200.html
