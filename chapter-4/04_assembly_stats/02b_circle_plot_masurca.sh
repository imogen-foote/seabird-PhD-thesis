...
ASSEMBLY_NAME=$2
ASSEMBLER=$3
ASSEMBLY_FILE=/nesi/nobackup/vuw03922/projects/$PROJECT/data/Chapter3/assemblies/$ASSEMBLER/1_raw/$ASSEMBLY_NAME/CA*/primary.genome.scf.fasta

out=/nesi/nobackup/vuw03922/projects/$PROJECT/output/Chapter3/${ASSEMBLER}_assembly/1_raw/$ASSEMBLY_NAME/$ASSEMBLY_NAME.circle_plot
mkdir -p $out
