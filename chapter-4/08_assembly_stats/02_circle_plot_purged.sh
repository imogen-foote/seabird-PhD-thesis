...
ASSEMBLY_NAME=$2
ASSEMBLER=$3
ASSEMBLY_FILE=/nesi/nobackup/vuw03922/projects/$PROJECT/data/Chapter3/assemblies/$ASSEMBLER/3_purge_haplotigs/$ASSEMBLY_NAME/assembly.fasta

out=/nesi/nobackup/vuw03922/projects/$PROJECT/output/Chapter3/${ASSEMBLER}_assembly/3_purge_haplotigs/$ASSEMBLY_NAME/$ASSEMBLY_NAME.circle_plot
mkdir -p $out
