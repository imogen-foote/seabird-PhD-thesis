...
#define directories
assembly=/nesi/nobackup/vuw03922/projects/$PROJECT/data/Chapter3/assemblies/$assembler/3_purge_haplotigs/$assembly_name/assembly.fasta
out_dir=/nesi/nobackup/vuw03922/projects/$PROJECT/output/Chapter3/${assembler}_assembly/3_purge_haplotigs/$assembly_name/$assembly_name.busco
