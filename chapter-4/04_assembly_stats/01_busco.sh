...
#define directories
assembly=/nesi/nobackup/vuw03922/projects/$PROJECT/data/Chapter3/assemblies/$assembler/1_raw/$assembly_name/*ssembly.fasta
out_dir=/nesi/nobackup/vuw03922/projects/$PROJECT/output/Chapter3/${assembler}_assembly/1_raw/$assembly_name/$assembly_name.busco
